...
class GuideWindow(QDialog):
    def __init__(self, pattern_type):
        ...
        self.current_step = 0
        self.guide_content = """
        <h1>Danish Christmas Hearts Weaving Guide</h1>
        ...
        <p> Now take the left stencil and its right half and fold it inwards, such that the right half is
            on top of the left half. Now take the right stencil and its left half and fold it inwards, such that the left half
            is on top of the right half as seen in the image above. You are now ready to do the weaving.</p>
        </div>
